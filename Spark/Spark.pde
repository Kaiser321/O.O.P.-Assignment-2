...
void mainMenu() {
  ...
  if(highlightButton(width / 2, 490, 220, 50)) {
    imageMode(CENTER);
  ...
  if(highlightButton(width / 2, 590, 170, 50)) {
    imageMode(CENTER);
  ...
  if(highlightButton(width / 2, 690, 245, 50)) {
    imageMode(CENTER);
  ...
  if(highlightButton(width / 2, 790, 90, 50)) {
    imageMode(CENTER);
...
boolean highlightButton(int x, int y, int width, int height)  {
